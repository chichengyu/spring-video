...
<input type="hidden" id="apiServer" name="apiServer" value="http://127.0.0.1:8081/resource"/>
<input type="hidden" id="bgmServer" name="bgmServer" value="http://127.0.0.1:8080/resource"/>
