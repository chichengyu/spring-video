...
2、禁止播放，管理员操作
    ...
    public VideosVo(String id, String userId, String audioId, String videoDesc, String videoPath, Float videoSeconds, Integer videoWidth, Integer videoHeight, String coverPath, Long likeCounts, Integer status, Date createTime) {
        this.id = id;
        this.userId = userId;
